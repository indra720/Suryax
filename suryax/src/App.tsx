  ...
  return (
    <Router>
      ...
      <a 
        ...
        className="fixed bottom-10 right-10 z-50 flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-95 transition-all duration-300 group"
      >
        <svg 
          viewBox="0 0 24 24" 
          width="32" 
        ...
        <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-white text-[#25D366] px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-gray-100">
          Chat with us
        </span>
      </a>
    </Router>
